  ...
  return (
    <SvgIcon {...props} viewBox="0 0 80 80">
      <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <title />
        <path d="M19,8H9A1,1,0,0,1,9,6H19a1,1,0,0,1,0,2Z" fill="#fff" />
        <path d="M19,13H9a1,1,0,0,1,0-2H19a1,1,0,0,1,0,2Z" fill="#fff" />
        <path d="M19,18H9a1,1,0,0,1,0-2H19a1,1,0,0,1,0,2Z" fill="#fff" />
        <circle cx="5" cy="7" fill="#fff" r="1" />
        <circle cx="5" cy="12" fill="#fff" r="1" />
        <circle cx="5" cy="17" fill="#fff" r="1" />
      </svg>{" "}
    </SvgIcon>
  );
};
    ...
    <SvgIcon viewBox="0 0 44 44" {...props}>
      <g>
        ...
        <g>
          ...
          <g>
            <circle class="st4" fill="#505050" cx="6.04" cy="19.32" r="0.75" />
            <path
              class="st4"
              fill="#505050"
